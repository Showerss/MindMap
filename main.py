...
output_frame = Frame(window, width=600, height=600, bg='white')
output_frame.pack(side='right')

#buttons frame on the left 1/3 of the window
buttons_frame = Frame(window, width=200, height=600, bg='light blue')
buttons_frame.pack(side='left')

#display some buttons to generate a blank page, anchor it to the buttons_frame
newButton = Button(buttons_frame, text='New')
...
#Question: does it make more sense to have a c# that calls python? or a python that calls c#?
